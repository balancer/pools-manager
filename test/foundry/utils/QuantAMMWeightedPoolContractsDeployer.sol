...
import { MockUpdateWeightRunner } from "../../../contracts/test/MockUpdateWeightRunner.sol";
import { MockChainlinkOracle } from "../../../contracts/test/MockChainlinkOracles.sol";
import { MockMomentumRule } from "../../../contracts/test/mockRules/MockMomentumRule.sol";
import { MockQuantAMMWeightedPool } from "../../../contracts/test/QuantAMMWeightedPoolMock.sol";
import { QuantAMMWeightedMathMock } from "../../../contracts/test/QuantAMMWeightedMathMock.sol";
...
import { IQuantAMMWeightedPool } from "../../../contracts/interfaces/IQuantAMMWeightedPool.sol";
import { IUpdateRule } from "../../../contracts/interfaces/IUpdateRule.sol";
...
contract QuantAMMWeightedPoolContractsDeployer is BaseContractsDeployer {
    ...
    ) internal returns (QuantAMMWeightedPoolFactory.CreationNewPoolParams memory retParams) {
    ...
    function createQuantAMMPool(
        ...
        QuantAMMWeightedPoolFactory.CreationNewPoolParams memory poolCreateSettings = _createPoolParams(
            tokens,
            rateProviders
        );
